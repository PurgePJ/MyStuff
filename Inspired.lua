...
if Required.Req.LevelUp:Value() and GetLevelPoints(myHero) >= 1 and GetLevel(myHero) >= Required.Req.SubReq:Value() then
  if Required.Req.SubReq:Value() then
